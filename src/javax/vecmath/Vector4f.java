 ...
 *
 */
public class Vector4f implements java.io.Serializable, Cloneable {
  ...
  public Vector4f()
  {
   ...
   public final void get(float[] t)
   {
     ...
     */ 
   public final void get(Vector4f t)
   {
      t.x = this.x;
      t.y = this.y;
      t.z = this.z;
   ...
   */
  public final void add(Vector4f t1, Vector4f t2)
  {
    this.x = t1.x + t2.x;
    this.y = t1.y + t2.y;
    this.z = t1.z + t2.z;
   ...
   */
  public final void add(Vector4f t1)
  { 
    this.x += t1.x;
    this.y += t1.y;
    this.z += t1.z;
   ...
   * @param t2 the second tuple
   */
  public final void sub(Vector4f t1, Vector4f t2)
  {
    this.x = t1.x - t2.x;
    this.y = t1.y - t2.y;
    this.z = t1.z - t2.z;
   ...
   * @param t1 the other tuple 
   */
  public final void sub(Vector4f t1)
  { 
    this.x -= t1.x;
    this.y -= t1.y;
    this.z -= t1.z;
   ...
   */
  public final void negate(Vector4f t1)
  {
    this.x = -t1.x;
    this.y = -t1.y;
    this.z = -t1.z;
   ...
   * @param t1 the source tuple
   */
  public final void scale(float s, Vector4f t1)
  {
    this.x = s*t1.x;
    this.y = s*t1.y;
    this.z = s*t1.z;
   ...
   */
  public final void scaleAdd(float s, Vector4f t1, Vector4f t2)
  {
    this.x = s*t1.x + t2.x;
    this.y = s*t1.y + t2.y;
    this.z = s*t1.z + t2.z;
     ...
     */  
    public final void scaleAdd(float s, Vector4f t1)
    {
   ...
   /**
     ...
     */  
    public boolean equals(Vector4f t1)
    {
        try {
   ...
   /**
     ...
     * @return  true or false
     */
    public boolean epsilonEquals(Vector4f t1, float epsilon)
    {
       float diff;
  ...
  /**
    ...
    */
   public final void clamp(float min, float max, Vector4f t)
   {
        if( t.x > max ) {
          x = max;
        } else if( t.x < min ){
  ...
  /** 
    ...
    *  @param t   the source tuple, which will not be modified
    */   
   public final void clampMin(float min, Vector4f t) 
   { 
        if( t.x < min ) {
          x = min;
        } else {
  ...
  /**  
    ...
    *  @param t   the source tuple, which will not be modified
    */    
   public final void clampMax(float max, Vector4f t)  
   {  
        if( t.x > max ) {
          x = max;
        } else {
  ...
  /**  
    ...
    *  @param t   the source tuple, which will not be modified
    */    
  public final void absolute(Vector4f t)
  {
       x = Math.abs(t.x);
       y = Math.abs(t.y);
       z = Math.abs(t.z);
  ...
  /**  
    ...
    */   
  public void interpolate(Vector4f t1, Vector4f t2, float alpha) 
  { 
  ...
  /**   
    ...
    *  @param alpha  the alpha interpolation parameter   
    */    
  public void interpolate(Vector4f t1, float alpha)  
  {  
     ...
     * @since vecmath 1.2
     */
    public Vector4f(Vector3f t1) {
	this(t1.x, t1.y, t1.z, 0.0f);
    }
